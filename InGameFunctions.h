...
void(*FEngSetTextureHash_Pkg)(char const* PackageName, DWORD ObjectHash, DWORD TextureHash) = (void(*)(char const*, DWORD, DWORD))0x495430;
...
void(__thiscall* ChoosePaintScreen_StartBrowsingPaints_Game)(DWORD* ChoosePaintScreen) = (void(__thiscall*)(DWORD*))0x55CC50;
void(__thiscall* ChoosePaintScreen_StopBrowsingPaints_Game)(DWORD* ChoosePaintScreen, bool ass) = (void(__thiscall*)(DWORD*, bool))0x55CE90;
...
void(__thiscall* PartSelectionScreen_StopBrowsingParts_Game)(DWORD* PartSelectionScreen, bool ass) = (void(__thiscall*)(DWORD*, bool))0x55EF80;
...
DWORD(*GetDoorlineHash_Game)(DWORD* RideInfo) = (DWORD(*)(DWORD*))0x612B70;
DWORD(*GetDoorlineMaskHash_Game)(DWORD* RideInfo) = (DWORD(*)(DWORD*))0x612C40;
int(__thiscall* CarPart_GetCarTypeNameHash)(DWORD* CarPart) = (int(__thiscall*)(DWORD*))0x610010;
void(__thiscall* CarPart_Print)(DWORD* CarPart) = (void(__thiscall*)(DWORD*))0x6319A0;
